...
im = PIL.Image.open(r"C:\Users\Maggie\Pictures\Woody pictures\S1.png")
...
image5 = openImage(r"C:\Users\Maggie\Pictures\Woody pictures\S1.png")


image1 = cv2.GaussianBlur(image1, (1, 1), 0)
...
holdf = holdsizefilter(holds, 16,92)
...
a = np.array(Routemake(holdf,image5,15,99))
print(a[0])
print(a[1])
print(a[0][2])
