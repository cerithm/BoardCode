...
def Routemake(holds,image,starthold,armlength):
    ...
    while Y>97:
        ...
        Y = Y - random.randint(int(0.5*dmax) ,int(1.5*dmax))
...
def Routemake2(holds,image,starthold1,starthold2,armlength):
    ...
    while Y1>90 or Y2>90:
        ...
        X2 = X1 + random.randint(int(-1.6*dmax) ,int(1.6*dmax))
        Y2 = Y1 - random.randint(int(-0.2*dmax) ,int(0.5*dmax))
        print(Y1)
        print(Y2)
        z1=[X1,Y1]
        z2=[X2,Y2]
...
a = np.array(Routemake2(holdf,image5,12,8,84))
print(a[0])
print(a[1])
print(a[0][2])
...
cv2.imwrite(r"C:\Users\Maggie\Pictures\Woody pictures\routemade.png", image5)
